...
export default class Items {
    ...
    generateWeapon() {
        let pistol = this.startVars.game.newImageObject({
            file: "assets/pistol.png",
            x: this.startVars.oPos.x - 30,
            y: this.startVars.oPos.y,
            scale: 0.38,
            self: this,
            userData: {
                setNear: function () {
                    console.log(this);
                    this.x = this.startVars.oPos.x - 30;
                    this.y = this.startVars.oPos.y;
                }.bind(this)
            }
        });

        let assault = this.startVars.game.newImageObject({
            file: "assets/assault.png",
            x: this.startVars.oPos.x - 45,
            y: this.startVars.oPos.y,
            scale: 0.35,
            userData: {
                setNear: function () {
